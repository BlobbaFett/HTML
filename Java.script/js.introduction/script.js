console.log('The three testimonies')
console.log(1)
...
console.log('As members of the church of latter day saints is esential to believe those things are true because make us know that we are not alone')